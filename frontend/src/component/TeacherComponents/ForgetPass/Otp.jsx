...
import PasswordReset from "./conformPass";
...
const handleResendOtp = async () => {
  try {
    ...
    const response = await teacherAxios.post('/resendOtp', { email });
...
const handleVerifyOtp = async () => {
  ...
  try {
    ...
    const response = await teacherAxios.post('/otpVerify', { enteredOtp, email });
