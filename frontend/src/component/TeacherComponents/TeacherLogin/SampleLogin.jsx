  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-6xl flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 hidden md:block flex items-center justify-center mt-28">
          <img
            className="w-100 h-90 rounded-3xl"
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col items-center">
          ...
          <form className="w-full max-w-md flex flex-col gap-4" onSubmit={loginHandle}>
            ...
            <input className="p-4 rounded-xl border dark:bg-gray-900" type="text" name="fullName" placeholder="Full Name" onChange={handleChangeForm} required />
            <input className="p-4 rounded-xl border dark:bg-gray-900" type="email" name="email" placeholder="Email" onChange={handleChangeForm} required />
            <input className="p-4 rounded-xl border dark:bg-gray-900" type={isPassShow ? "text" : "password"} name="password" placeholder="Password" onChange={handleChangeForm} required />
            <input className="p-4 rounded-xl border dark-bg-gray-900" type={isPassShow ? "text" : "password"} name="rePassword" placeholder="Re-enter Password" onChange={handleChangeForm} required />
