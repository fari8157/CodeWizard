    ...
    <section className="bg-gray-50  dark:bg-gray-900 min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-6xl flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16">
          ...
          <>
            <button onClick={handleLoginWithGoogle} className=" dark:bg-gray-900 bg-white border py-3 w-full rounded-xl mt-5 flex justify-center items-center text-lg hover:scale-105 duration-300 text-[#002D74]  dark:text-blue-400">
