...
const TeacherRequest = () => {
  ...
  const accessChange = (email, isApprovel) => {
    console.log(email,isApprovel);
    adminAxios
      .put(
        '/updateTeacherApprovel',
        { email, isApprovel },
        {
          headers: {
            'Content-Type': 'application/json',
...
function formatCurrentDate(date) {
        ...
        <div className="mb-4">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {paginatedData.map((teacher, index) => (
                <tr key={teacher._id}>
                  ...
                  <td className="px-6 py-4  whitespace-nowrap text-center">
                  <div className='text-sm text-gray-900'>{teacher.fullName}</div>
                    </td>
                  <td className="px-6 py-4  whitespace-nowrap text-center">
          ...
          >
            View Details
                  ...
                  <button class="relative inline-flex items-center justify-center px-6 p-1 py-1 overflow-hidden font-medium text-green-500 transition duration-300 ease-out border-2 border-green-500 rounded-full shadow-md group" onClick={() => accessChange(teacher.email, true)}>
  ...
  <span class="relative invisible">Approve</span>
                    ...
                    {/* <button
                      ...
                      onClick={() => accessChange(teacher.email, true)}
                    >
                      Approve
                    </button> */}
                    {/* <button
                 ...
                 <button class="relative inline-flex items-center justify-start inline-block px-6 py-1.5  overflow-hidden font-bold rounded-full group"  onClick={() => accessChange(teacher.email, false)}>
